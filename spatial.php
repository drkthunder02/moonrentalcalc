...
$moons = $db->fetchRowMany('SELECT * FROM Moons');
...
foreach($moons as $moon) {
    ...
    $price = SpatialMoons($moon['FirstOre'], $moon['FirstQuantity'], 
                          $moon['SecondOre'], $moon['SecondQuantity'], 
                          $moon['ThirdOre'], $moon['ThirdQuantity'], 
                          $moon['FourthOre'], $moon['FourthQuantity'], $db);
